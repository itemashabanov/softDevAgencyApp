      ...
      <div className="flex-1 flex flex-col justify-center items-center pt-10 lg:pt-6">
        ...
        >
          ...
          {status.submitted ? (
            ...
            <>
              <input
                className="bg-cyan-700 text-white outline-none border-2 border-white rounded-3xl px-8 py-2"
                id="companyName"
                name="companyName"
                required
                maxLength={128}
              ...
              />
              <textarea
                className="bg-cyan-700 text-white outline-none border-2 border-white rounded-3xl px-8 py-6 min-h-[16em]"
                name="message"
                id="message"
                required
                maxLength={1048576}
